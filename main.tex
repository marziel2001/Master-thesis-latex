...
\title{Praca magisterska - Porównanie i analiza modeli Speech To Text v1}
...
\addcontentsline{toc}{section}{Unnumbered Section} % Dodanie sekcji do spisu treści
...
% SPIS TREŚCI
% Promotorka: WSTĘP (Motywacji → Przegląd źródeł → Metodologia → Metoda) [10-20 Stron]
% Promotorka: WYBRANA METODA BADAWCZA (Innowacja) [10-15 stron]
% Promotorka: IMPLEMENTACJA METODA I BADANIA (np.: symulacyjne/laboratoryjne) [30-40 stron]
% Promotorka: POTENCJAŁ KOMERCJALIZACJI/RYNKOWY [5-10 stron]
% Promotorka:
%     ZAKOŃCZENIE [3-5 stron]
%     BIBLIOGRAFIA (min. 30 pozycji)
%     SPISY (tabele, rysunki, wykres)
%     ZAŁĄCZNIKI
...
%  Marcel Notatki
% Miscrosoft ma rozne rozwiazania speech to text: https://learn.microsoft.com/en-us/azure/ai-services/speech-service/speech-to-text